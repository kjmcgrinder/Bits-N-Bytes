...
<body>
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    ...
    <form id="form1" runat="server" class="secondary">
        ...
        <asp:GridView ID="repairGridview" runat="server" AllowSorting="True" AutoGenerateColumns="False" AutoGenerateDeleteButton="True" AutoGenerateEditButton="True" DataSourceID="RepairDataSource">
            <Columns>
