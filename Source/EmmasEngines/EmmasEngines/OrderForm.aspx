...
<%--                            <asp:TextBox ID="txtPart" runat="server" placeholder="2 stroke oil" ></asp:TextBox>--%>
                            <asp:DropDownList ID="ddlPart" runat="server" AppendDataBoundItems="True"  DataValueField="prodName" Style="margin-bottom: 20px; padding: 12px; border: 1px solid #ccc; border-radius: 3px; width: 225px;" AutoPostBack="True" DataSourceID="SqlDataSource1" DataTextField="prodName" Width="225px">
...
<%--                            <asp:TextBox ID="txtBrand" runat="server" placeholder="Castrol"></asp:TextBox>--%>
                            <asp:DropDownList ID="ddlBrand" runat="server" AppendDataBoundItems="True"  Style="margin-bottom: 20px; padding: 12px; border: 1px solid #ccc; border-radius: 3px; width: 225px;" AutoPostBack="True" DataSourceID="SqlDataSource2" DataTextField="prodBrand" DataValueField="prodName" Width="225px">
                            ...
                            <asp:TextBox ID="txtQuantity" type="number" min="1" max="99" runat="server" placeholder="1 ~ 99" Width="225px" CssClass="inputBox"></asp:TextBox><br />

                            <label for="lblSize"><i class="fa fa-address-card-o"></i>Size</label><br />
                            <asp:TextBox ID="txtSize" placeholder="6.00" runat="server" Width="225px" CssClass="inputBox"></asp:TextBox><br />
                            <br />
