                ...
                <div class="col-75">
                    <div class="container">
                        ...
                        <div class="row">
                            <div class="col-50">
                                <br />
                                <h3 class="IndexHeaderA">Create Employee</h3>
                                <br />
                                <br />
                                <br />
                                ...
                                <asp:TextBox runat="server" ID="username" ReadOnly="true"></asp:TextBox><br />
    ...
    <script>
        ...
        function GenerateUsername() {
            if (document.getElementById("confirmPassword").className != "aspNetDisabled") {
                ...
                document.getElementById("username").value = document.getElementById("fname").value[0] + document.getElementById("lname").value + id;
            }
        }
    </script>
</body>
