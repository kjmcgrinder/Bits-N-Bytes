...
<body>
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    ...
    <form id="form1" runat="server" class="secondary">
        ...
        <asp:GridView ID="GridView1" runat="server" AllowSorting="True" GridLines="Horizontal" Width="1832px" AutoGenerateColumns="False" DataSourceID="dsCustomers">
            <Columns>
                <asp:BoundField DataField="FULL" HeaderText="Full Name" ReadOnly="True" SortExpression="FULL" />
                <asp:BoundField DataField="custAddress" HeaderText="Address" SortExpression="custAddress" />
                <asp:HyperLinkField NavigateUrl="customer-details.aspx" Text="Details" />
            </Columns>
        </asp:GridView>
