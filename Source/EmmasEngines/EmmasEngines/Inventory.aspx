...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div style="margin-right: 20px; margin-left: 20px;">
        <asp:Button ID="btnOrderStock" runat="server" Text="Order Stock" CssClass="IndexButton" PostBackUrl="~/OrderForm.aspx" Height="56px" Width="160"/>
        <asp:Button ID="btnOrderView" runat="server" Text="View Orders" CssClass="IndexButton"  PostBackUrl="~/Orders.aspx" Height="56px" Width="160"/><br />
        <br />
        <b>Product Name:</b>
        <br />
